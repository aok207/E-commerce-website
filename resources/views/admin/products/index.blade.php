...
@section('search')
    <form action="{{ route('admin.products.index') }}" class="flex justify-center flex-1 lg:mr-32">
    ...
    <div class="min-w-0 p-4 m-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.products.create') }}"
                class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">Add
                New Product</a>
        </div>
                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3">categoires</th>
                            <th class="px-4 py-3">price</th>
                            <th class="px-4 py-3">quantity in stock</th>
                            ...
                            <tr class="text-gray-700 dark:text-gray-400 user-row">
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm w-[120px]">
                                        ...
                                        @else
                                            <img src="{{ asset("images/$product->image") }}" alt="" class="w-full h-full object-cover">
                                        @endif
                                    </div>
                                </td>
