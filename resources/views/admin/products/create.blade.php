...
@section('search')
    <form action="{{ route('admin.products.store') }}" class="flex justify-center flex-1 lg:mr-32">
                ...
                <form action="{{ route('admin.products.store') }}" method="POST"
                    ...
                    <label class="flex flex-col gap-4 text-sm mb-4">
                        ...
                        <input
                            ...
                            name="title" aria-label="title" required aria-required="true" />
                    </label>
                    ...
                    <label class="flex flex-col gap-4 text-sm mb-4">
                        ...
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            name="image" aria-label="image" required aria-required="true" type="file" />
                    </label>

                    <label class="flex flex-col gap-4 mt-4 text-sm mb-4">
                    ...
                    <label class="flex flex-col gap-4 text-sm mb-4">
                        ...
                        <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                            <input
                                ...
                                name="price" aria-label="price" required aria-required="true" type="number"
                                step="any" />
                            <div class="absolute inset-y-0 flex items-center ml-3 mt-1 pointer-events-none">
                                $
                            </div>
                        </div>
                    </label>
                    ...
                    <label class="flex flex-col gap-4 text-sm mb-4">
                        <span class="text-gray-700 dark:text-gray-400">Quantity in stock</span>
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            name="quantity" aria-label="quantity in stock" required aria-required="true"
                            type="number" />
                    </label>
                    ...
                    <label class="flex flex-col gap-4 text-sm mb-4">
                        ...
                        <textarea
                            ...
                            rows="3" placeholder="Enter the description of the product..." name="description"
                            aria-label="description of product" required aria-required="true"></textarea>
                    </label>

                    <button type="submit"
                        class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">Create</button>
                </form>
            </div>
        </div>
    </div>
