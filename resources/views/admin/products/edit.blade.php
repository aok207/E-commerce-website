            ...
            <div class="w-full overflow-x-auto">
                <form action="{{ route('admin.products.update', $product->id) }}" method="POST"
                    ...
                    @if (str_starts_with($product->image, 'https:'))
                        <img src="{{ $product->image }}" alt="{{ $product->title }}" class="w-[300px] mb-4" />
                    @else
                    ...
                    <label class="flex flex-col gap-4 text-sm mb-4">
                        ...
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            name="image" aria-label="image" type="file" />
                    </label>
                        ...
                        <select multiple
                            ...
                            @foreach ($categories as $category)
                                @foreach ($product->categories as $product_category)
                                    @if ($category->slug === $product_category->slug)
                    ...
                    <label class="flex flex-col gap-4 text-sm mb-4">
                        ...
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            name="quantity" aria-label="quantity in stock" required aria-required="true" type="number"
                    ...
                    <label class="flex flex-col gap-4 text-sm mb-4">
                        ...
                        <textarea
                            ...
                            aria-label="description of product" required aria-required="true">{{ $product->description }}</textarea>
                    </label>
