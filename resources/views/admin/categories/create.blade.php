...
@section('search')
    <form action="{{ route('admin.categories.index') }}" class="flex justify-center flex-1 lg:mr-32">
        <div class="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
            ...
            <input name="search"
                ...
                type="text" placeholder="Search categories" aria-label="Search categories" />
        </div>
    </form>
@endsection
                ...
                <form action="{{ route('admin.categories.store') }}" method="POST"
                    ...
                    <label class="flex flex-col gap-4 text-sm mb-4">
                        ...
                        <input
                            ...
                            name="name" aria-label="name" required aria-required="true" />
                    </label>
